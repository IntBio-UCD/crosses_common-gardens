...
### Extract asc values
```{r, eval=FALSE}
setwd("/Users/bqc/Library/Mobile Documents/com~apple~CloudDocs/Documents/UCDavis_Postdoc/crosses_common-gardens/input/Flint_WY2025/") #wherever the unzipped Flint files are 
...
path_name <- c("aet_WY2025","cwd_WY2025","pck_WY2025",
               "pet_WY2025","ppt_WY2025","tmn_WY2025","tmx_WY2025") #these should be the folders that are made when you unzip the .zip files, there should be a bunch of .asc files in these folders 
...
walk(path_name, .progress = TRUE, .f = function(path) {
  ...
  var_name <- str_extract(path, "[a-z]+(?=_WY2025)") #this says find the lowercase letters that appear before "_WY2025"
  #(?<=/) #for testing the code (can ignore this)
  ...
  for (j in 1:length(file_list)) {
    ...
    file.remove(dec_file_name) #this removes the large asc files from your computer once you're done with the extraction 
  }
...
# Save the data frame
  new_file_name <- paste0("Test_", var_name, "_WY2025.csv") #change this to whatever you want your output files to be called
