...
hypothesis(surv_parent_binary_m4,
           ...
           scope = "standard")
```
This shows that the posterior probability that BH increases survivability is 0.64
...
hypothesis(surv_parent_binary_m4,
           ...
           scope = "standard")
```
This shows that the posterior probability that WV is better than BH is 0.78
